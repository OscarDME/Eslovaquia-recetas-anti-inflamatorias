...
const featureColors = [
  "from-[#0B533E] to-[#1a7a4f]",
  "from-[#1a7a4f] to-[#0B533E]",
  "from-[#0B533E] to-[#1a7a4f]",
  "from-[#1a7a4f] to-[#0B533E]",
  "from-[#0B533E] to-[#1a7a4f]",
];
          ...
          {features.items.map((item, index) => (
            ...
            >
              ...
              <div className="flex-1 p-6 md:p-8">
                <h3 className="text-[#c8e6a0] text-2xl md:text-3xl font-black mb-2">
                  {item.title}
                </h3>
                <div className="w-20 h-1 bg-[#c8e6a0]/50 rounded mb-4"></div>
