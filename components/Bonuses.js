...
export default function Bonuses() {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-[#0B533E] to-[#1a7a4f] py-14 md:py-20 px-4 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="flex justify-center mb-6">
          <span className="bg-gradient-to-r from-amber-400 to-yellow-400 text-[#0B533E] font-black uppercase text-sm px-6 py-2 rounded-full shadow-lg flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
          {bonuses.items.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-[#0B533E] text-lg font-bold mb-2 leading-tight">
                {item.title}
              </h3>
