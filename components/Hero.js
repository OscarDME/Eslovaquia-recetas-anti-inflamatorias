...
export default function Hero() {
  ...
  return (
    <section className="w-full">
      ...
      {/* Hero Content */}
      <div className="bg-gradient-to-b from-[#0B533E] via-[#1a7a4f] to-[#1a7a4f] relative overflow-hidden">
        {/* Decorative circles */}
        ...
        <div className="max-w-5xl mx-auto px-4 py-14 md:py-20 relative z-10">
          ...
          <h1 className="text-center mb-8">
            <span className="block text-[#c8e6a0] text-5xl md:text-7xl lg:text-8xl font-black leading-[1.05] tracking-tight drop-shadow-lg">
              {hero.headline.line1}
            </span>
            <span className="block text-[#c8e6a0] text-5xl md:text-7xl lg:text-8xl font-black leading-[1.05] tracking-tight drop-shadow-lg">
          ...
          {/* Solution Title */}
          <p className="text-[#c8e6a0] text-center text-lg md:text-xl font-semibold italic mb-6">
            {hero.solutionTitle}
          </p>
          ...
          <div className="text-center">
            <button
              ...
              className="inline-block bg-[#28a745] hover:bg-[#218838] text-white font-bold py-5 px-10 rounded-xl shadow-[0_8px_30px_rgba(34,197,94,0.4)] hover:shadow-[0_12px_40px_rgba(34,197,94,0.6)] text-lg md:text-xl border-b-4 border-[#1e7e34] transition-all duration-300 cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
            >
              🛒 {hero.cta}
            </button>
          </div>
