...
const BASE_CHECKOUT_URL = "https://www.oriopay.app/p/protizapalove-recepty";
...
export default function FinalCta() {
  ...
  // Abre el checkout embebido AQUÍ MISMO (sin redirección). InitiateCheckout al abrir.
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 text-center mb-8 border border-gray-100">
          <h2 className="text-[#0B533E] text-2xl md:text-3xl font-black mb-4 leading-tight">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 text-center border border-gray-100">
          ...
          <div className="flex items-baseline justify-center gap-1 mb-5">
            <span className="text-[#0B533E] text-6xl md:text-7xl font-black tracking-tighter whitespace-nowrap">
              {finalCta.offerPrice}
            </span>
          </div>
          ...
          {/* Checkout OrioPay — full-bleed en móvil (-mx-6 md:-mx-10); altura auto. */}
